...
// print TEXT
$pdf->PrintChapter(1, 'LOREM IPSUM [TEXT]', './tcpdf/examples/data/chapter_demo_1.txt', false);

// print HTML
$pdf->PrintChapter(2, 'LOREM IPSUM [HTML]', './tcpdf/examples/data/chapter_demo_2.txt', true);
