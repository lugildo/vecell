			...
			if( ($('#sDiaCorte').val() > 0) && ($('#sMesComp').val() > 0) && ($('#sAno').val() > 0)  && ($('#iAssociacao').val() > 0)) {
				...
				jQuery(function($) {
					...
					jQuery(grid_selector).jqGrid({
						...
						url:'http://104.236.0.195/show_relatorios.php?sConveniada=1&sTipo=analitico&sDiaCorte='+sDiaCorte+'&sAno='+sAno+"&sRescindidos="+sRescindidos+"&sBloqueados="+sBloqueados+'&sLojasProprias='+sLojasProprias+'&sMesComp='+sMesComp+'&iAssociacao='+iAssociacao,
						datatype: "json",
						height: 250,
